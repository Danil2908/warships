...
class Destroyer(OurShip, EnemyShip):
    def __init__(self, ship_type):
        if ship_type == "our":
            OurShip.__init__(self, color=our_ship_color, speed=50, vision_range=5, attack_range=3, health=80, power=10,
                             accuracy=0.7)
        else:
            EnemyShip.__init__(self, color=enemy_ship_color, speed=50, vision_range=5, attack_range=3, health=80,
